...
const topics = [
  { title: "Machine Learning & AI", desc: "Modeling • Scikit-learn", color: "from-neon-purple/90 to-purple-600/90", size: "w-56 h-56 md:w-[280px] md:h-[280px]", delay: 0, pos: { x: -300, y: -240 } },
  { title: "Data Analysis", desc: "Pandas • Python", color: "from-neon-blue/90 to-blue-600/90", size: "w-64 h-64 md:w-[320px] md:h-[320px]", delay: 1, pos: { x: 0, y: -60 } },
  { title: "Problem Solving", desc: "C++ • Algorithms", color: "from-neon-teal/90 to-teal-600/90", size: "w-52 h-52 md:w-64 md:h-64", delay: 0.5, pos: { x: 300, y: -240 } },
  { title: "Backend Integration", desc: "Flask • Python", color: "from-violet-500/90 to-fuchsia-600/90", size: "w-48 h-48 md:w-56 md:h-56", delay: 1.5, pos: { x: -380, y: 120 } },
  { title: "Database Management", desc: "MySQL • Relational Data", color: "from-blue-600/90 to-indigo-600/90", size: "w-48 h-48 md:w-56 md:h-56", delay: 0.8, pos: { x: 380, y: 120 } },
  { title: "Tools & Environments", desc: "Google Colab • Kaggle", color: "from-emerald-500/90 to-teal-600/90", size: "w-44 h-44 md:w-52 md:h-52", delay: 2, pos: { x: -160, y: 280 } },
  { title: "Web Technologies", desc: "HTML • CSS • JS", color: "from-sky-500/90 to-blue-500/90", size: "w-44 h-44 md:w-52 md:h-52", delay: 1.2, pos: { x: 160, y: 280 } }
];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
        ...
        >
          ...
          <P className="text-gray-400 mb-10 max-w-xl mx-auto text-lg leading-relaxed">
            My strongest technical domains, from intelligent machine learning algorithms to solving complex problems via code.
          </P>
        </motion.div>
      </div>
