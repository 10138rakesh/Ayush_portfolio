        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <H1 className="text-6xl sm:text-7xl lg:text-[6rem] xl:text-[7rem] leading-none tracking-tight">
              ...
              <span className="text-transparent bg-clip-text bg-[length:200%_auto] animate-[gradient_10s_linear_infinite]" style={{ backgroundImage: "linear-gradient(to right, #0ea5e9, #a855f7, #10b981, #f59e0b, #f43f5e, #0ea5e9)" }}>Ayush</span>.
            </H1>

            <div className="space-y-4 max-w-2xl">
              <P className="text-xl sm:text-2xl text-muted-foreground font-medium">
                Artificial Intelligence & Machine Learning Enthusiast focused on intelligent solutions.
              </P>
              <P className="text-base sm:text-lg text-muted-foreground/80 leading-relaxed">
                I combine strong analytical skills with modern libraries like Pandas and Scikit-learn to build data-driven applications and solve complex problems.
              </P>
            </div>
