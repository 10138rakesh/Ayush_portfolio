      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <motion.div variants={itemVariants} className="mb-16">
            ...
            <H2 className="text-4xl md:text-5xl border-none">Passionate about AI & Data</H2>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[minmax(180px,auto)]">
            ...
            <motion.div variants={itemVariants} className="md:col-span-2 md:row-span-2">
              <div className="h-full bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl p-8 lg:p-10 shadow-[0_8px_32px_rgba(0,0,0,0.3)] hover:bg-white/[0.07] transition-colors relative overflow-hidden group">
                ...
                <div className="space-y-6 relative z-10 text-gray-300 text-lg leading-relaxed">
                  <p>
                    I am a B.Tech Computer Science student at Lovely Professional University who is passionate about Artificial Intelligence and Machine Learning. My journey is driven by curiosity, consistency, and a strong problem-solving mindset.
                  </p>
                  <p>
                    With hands-on experience in C++, Python, Pandas, and Scikit-learn, I focus on extracting insights from data and building intelligent algorithms. I enjoy leveraging AI libraries to bring innovative ideas to life.
                  </p>
                  <p>
                    I continuously improve my skills in problem-solving and exploring new technologies in the Data Science and AI domain.
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="md:col-span-1 md:row-span-2 flex flex-col gap-6">
              <div className="h-1/2 bg-gradient-to-br from-gray-900/80 to-black backdrop-blur-xl border border-gray-800 rounded-3xl p-8 flex flex-col justify-center relative overflow-hidden group hover:border-neon-purple/50 transition-colors">
                ...
                <div className="text-3xl md:text-3xl font-bold text-white mb-2 tracking-tight">Dedicated Learner</div>
                <div className="text-xs font-mono text-gray-400">Strong problem-solving skills through consistent practice in Data Structures & Algorithms and multiple certifications.</div>
              </div>
              ...
              <div className="h-1/2 bg-gradient-to-br from-gray-900/80 to-black backdrop-blur-xl border border-gray-800 rounded-3xl p-8 flex flex-col justify-center relative overflow-hidden group hover:border-neon-teal/50 transition-colors">
                ...
                <div className="text-3xl md:text-3xl font-bold text-white mb-2 tracking-tight">Top 15 Finalist</div>
                <div className="text-xs font-mono text-gray-400">Secured a top 15 position in an internal LPU coding and hackathon challenge with 200+ participants.</div>
              </div>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="md:col-span-1">
              <div className="h-full bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl p-8 flex flex-col justify-center group hover:bg-white/[0.08] transition-colors relative overflow-hidden">
                ...
                <H3 className="text-xl text-white mb-2">Artificial Intelligence & ML</H3>
                <p className="text-sm text-gray-400 font-sans">Building intelligent solutions using Python, Pandas, Scikit-learn, and data-driven technologies.</p>
              </div>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="md:col-span-1">
              <div className="h-full bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl p-8 flex flex-col justify-center group hover:bg-white/[0.08] transition-colors overflow-hidden relative">
                ...
                <H3 className="text-xl text-white mb-2 z-10 relative">Data Integration</H3>
                <p className="text-sm text-gray-400 font-sans z-10 relative">Connecting sophisticated machine learning logic with databases like MySQL and utilizing Google Colab.</p>
              </div>
            </motion.div>
